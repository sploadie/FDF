...
/*   Updated: 2015/01/06 10:24:34 by tgauvrit         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	new_fdf_img(t_fdf_win *win)
{
	...
	ft_putendl(ft_itoa(win->img_bits_per_pixel));
	ft_putstr("img_endian: ");
	ft_putendl(ft_itoa(win->img_endian));
	ft_putstr("img_size_line: ");
	ft_putendl(ft_itoa(win->img_size_line));
}
